  ...
  <header class="site-header" data-header>
    ...
    <div class="header-nav-stack">
      <nav class="utility-nav" aria-label="Utility navigation">
        ...
        <a href="${A(`#contact`)}">Partner With Us</a>
        <a href="#contact">Contact us</a>
      </nav>

      <nav class="desktop-nav" aria-label="Primary navigation">
        <button type="button" data-desktop-trigger="about" aria-expanded="false">About Us<img src="${k(`images/nav-chevron.svg`)}" alt="" class="nav-chevron" /></button>
        <button type="button" data-desktop-trigger="research" aria-expanded="false">Research &amp; Development<img src="${k(`images/nav-chevron.svg`)}" alt="" class="nav-chevron" /></button>
        <button type="button" data-desktop-trigger="manufacturing" aria-expanded="false">Manufacturing Infrastructure<img src="${k(`images/nav-chevron.svg`)}" alt="" class="nav-chevron" /></button>
        <button type="button" data-desktop-trigger="businesses" aria-expanded="false">Our Businesses<img src="${k(`images/nav-chevron.svg`)}" alt="" class="nav-chevron" /></button>
        <button type="button" data-desktop-trigger="resources" aria-expanded="false">Resources<img src="${k(`images/nav-chevron.svg`)}" alt="" class="nav-chevron" /></button>
        <button type="button" data-desktop-trigger="life" aria-expanded="false">Life@Eastman<img src="${k(`images/nav-chevron.svg`)}" alt="" class="nav-chevron" /></button>
      </nav>
    </div>

    <div class="header-actions">
      <a class="phone-link" href="tel:18004198610" aria-label="Call Eastman">
        <img src="${k(`images/phone-icon.svg`)}" alt="" class="phone-icon" />
        1800 419 8610
      </a>
    ...
    <button class="menu-toggle" type="button" aria-expanded="false" aria-controls="mobile-menu" aria-label="Open menu" data-menu-toggle>
      <img src="${k(`images/menu-icon.svg`)}" alt="" />
    ...
    <div class="desktop-mega-menu" data-desktop-menu>
      <section class="mega-panel mega-panel--card" data-desktop-panel="about" aria-label="About Us submenu">
        <!-- <h2>Company</h2> -->
        <!--<a class="is-current" href="${A(`about.html`)}">Overview &amp; Group Companies</a>-->
        <a href="${A(`about.html`)}">Overview &amp; Group Companies</a>
        <a href="${A(`about.html`)}">Eastman Auto &amp; Power in Nos.</a>
        <a href="${A(`corporate-history.html`)}">Corporate History</a>
        <a href="${A(`corporate-governance.html`)}">Corporate Governance</a>
        <a href="${A(`disclosures.html`)}">Shareholder Information</a>
        <a href="${A(`about.html`)}">CSR</a>
      </section>
      <section class="mega-panel mega-panel--card" data-desktop-panel="research" aria-label="Research and Development submenu">
        <!-- <h2>Research &amp; Development</h2> -->
        <a href="${A(`#research`)}">Overview</a>
        <a href="${A(`#research`)}">Conventional Tubular Batteries</a>
        <a href="${A(`#research`)}">Power Electronics</a>
        <a href="${A(`#research`)}">Lithium-ion Batteries Solar Panels</a>
      </section>
      <section class="mega-panel mega-panel--card" data-desktop-panel="manufacturing" aria-label="Manufacturing Infrastructure submenu">
        ...
        <a href="${A(`manufacturing-infrastructure.html`)}">Overview</a>
        <a href="${A(`conventional-tubular-batteries.html`)}">Conventional Tubular Batteries</a>
        <a href="${A(`power-electronics.html`)}">Power Electronics</a>
        <a href="${A(`lithium-batteries.html`)}">Lithium-ion Batteries</a>
        <a href="${A(`solar-panels.html`)}">Solar Panels</a>
      </section>
      <section class="mega-panel mega-panel--card" data-desktop-panel="businesses" aria-label="Our Businesses submenu">
        <!-- <h2>Our Businesses</h2> -->
          <a href="${A(`business.html`)}">Overview</a>
        <a href="${A(`last-mile-e-mobility-solutions.html`)}">Last Mile E-Mobility Solutions</a>
        <a href="${A(`residential-solar-with-storage.html`)}">Residential Solar With Storage</a>
        <a href="${A(`continued-energy-solutions.html`)}">Continued Energy Solutions</a>
        <a href="${A(`advanced-electronics-manufacturing.html`)}">Advanced Electronics Manufacturing</a>
        <a href="${A(`business.html#businesses`)}">Global Business</a>
      </section>
      <section class="mega-panel mega-panel--card" data-desktop-panel="resources" aria-label="Resources submenu">
        <!-- <h2>Resources</h2> -->
        <a href="${A(`#resources`)}">Overview</a>
        <a href="${A(`#resources`)}">Blogs</a>
        <a href="${A(`#resources`)}">Whitepaper</a>
        <a href="${A(`#resources`)}">Media</a>
        <a href="${A(`#resources`)}">Social Feed</a>
        <a href="${A(`#resources`)}">Videos</a>
      </section>
      <section class="mega-panel mega-panel--card" data-desktop-panel="life" aria-label="Life at Eastman submenu">
        <!-- <h2>Life @ Eastman</h2> -->
        <a href="${A(`#life`)}">Great Place to Work</a>
        <a href="${A(`#life`)}">Careers</a>
      </section>
    </div>
  </header>
  ...
  <nav class="mobile-menu" id="mobile-menu" aria-label="Mobile navigation" data-mobile-menu>
    <div class="mobile-menu-inner" data-lenis-prevent>
      <div class="mobile-nav-item">
        <button type="button" class="mobile-nav-trigger" aria-expanded="false">About Us<img src="${k(`images/nav-chevron.svg`)}" alt="" /></button>
        <div class="mobile-submenu">
          <a href="${A(`about.html`)}">Explore About Us</a>
          <h3>Company</h3>
          <a href="${A(`about.html`)}">Overview &amp; Group Companies</a>
          <a href="${A(`eapl-in-numbers.html`)}">Eastman in Numbers</a>
          <a href="${A(`about.html`)}">Our Values</a>
          <h3>Governance</h3>
          <a href="${A(`corporate-history.html`)}">Corporate History</a>
          <a href="${A(`corporate-governance.html`)}">Corporate Governance</a>
          <a href="${A(`disclosures.html`)}">Shareholders Information</a>
        </div>
      </div>
      <div class="mobile-nav-item">
        <button type="button" class="mobile-nav-trigger" aria-expanded="false">Research &amp; Development<img src="${k(`images/nav-chevron.svg`)}" alt="" /></button>
        <div class="mobile-submenu">
          <a href="${A(`#research`)}">Overview</a>
          <a href="${A(`#research`)}">Conventional Energy Storage</a>
          <a href="${A(`#research`)}">Power Electronics</a>
          <a href="${A(`#research`)}">Lithium-Ion Battery Pack</a>
        </div>
      </div>
      <div class="mobile-nav-item">
        <button type="button" class="mobile-nav-trigger" aria-expanded="false">Manufacturing Infrastructure<img src="${k(`images/nav-chevron.svg`)}" alt="" /></button>
        <div class="mobile-submenu">
          <a href="${A(`manufacturing-infrastructure.html`)}">Overview</a>
          <a href="${A(`conventional-tubular-batteries.html`)}">Conventional Tubular Batteries</a>
          <a href="${A(`lithium-batteries.html`)}">Lithium-ion Batteries</a>
      ...
      <div class="mobile-nav-item">
        <button type="button" class="mobile-nav-trigger" aria-expanded="false">Our Businesses<img src="${k(`images/nav-chevron.svg`)}" alt="" /></button>
        <div class="mobile-submenu">
          <a href="${A(`business.html`)}">Overview</a>
          <a href="${A(`last-mile-e-mobility-solutions.html`)}">Last Mile E-Mobility Solutions</a>
          <a href="${A(`residential-solar-with-storage.html`)}">Solar Solutions</a>
          <a href="${A(`continued-energy-solutions.html`)}">Continued Energy Solutions</a>
          <a href="${A(`advanced-electronics-manufacturing.html`)}">Advanced Electronics Manufacturing</a>
          <a href="${A(`business.html#businesses`)}">Global Businesses</a>
        </div>
      </div>
      <div class="mobile-nav-item">
        <button type="button" class="mobile-nav-trigger" aria-expanded="false">Resources<img src="${k(`images/nav-chevron.svg`)}" alt="" /></button>
        <div class="mobile-submenu">
          <a href="${A(`#resources`)}">Overview</a>
          <a href="${A(`#resources`)}">Blogs</a>
          <a href="${A(`#resources`)}">White Paper</a>
          <a href="${A(`#resources`)}">Media</a>
          <a href="${A(`#resources`)}">Videos</a>
          <a href="${A(`#resources`)}">Social Feed</a>
        </div>
      ...
      <div class="mobile-nav-item">
        <button type="button" class="mobile-nav-trigger" aria-expanded="false">Life@Eastman<img src="${k(`images/nav-chevron.svg`)}" alt="" /></button>
        <div class="mobile-submenu">
          <a href="${A(`#life`)}">Great Place to Work</a>
          <a href="${A(`#life`)}">Careers</a>
        </div>
      ...
      <div class="mobile-menu-actions">
        <a class="phone-link" href="tel:18004198610"><img src="${k(`images/phone-icon.svg`)}" alt="" />1800 419 8610</a>
        <a class="trade-chip" href="#contact">Trade Enquiry</a>
      </div>
    </div>
  </nav>
  ...
  <footer class="site-footer" id="contact">
    <div class="footer-grid">
      <div class="footer-column footer-brand-column">
        <a class="footer-brand" href="${A()}" aria-label="Eastman home">
          <img src="${k(`images/footer_logo.svg`)}" alt="Eastman" />
        </a>
        ...
        <section class="footer-group">
          <h3>About Us</h3>
          <a href="${A(`about.html`)}">Overview &amp; Group Companies</a>
          <a href="${A(`eapl-in-numbers.html`)}">Eastman Auto &amp; Power in Nos.</a>
          <a href="${A(`corporate-history.html`)}">Corporate History</a>
          <a href="${A(`corporate-governance.html`)}">Corporate Governance</a>
          <a href="${A(`disclosures.html`)}">Shareholder Information</a>
          <a href="${A(`about.html`)}">CSR</a>
      ...
      <div class="footer-column">
        <section class="footer-group">
          ...
          <a href="${A(`#research`)}">Conventional Tubular Batteries</a>
          <a href="${A(`#research`)}">Power Electronics</a>
          <a href="${A(`#research`)}">Lithium-ion Batteries</a>
          <a href="${A(`#research`)}">Solar Panels</a>
        </section>
        <section class="footer-group">
      ...
      <div class="footer-column contact-col">
        <section class="footer-group">
          ...
          <p class="contact-row"><img src="${k(`images/footer-location.svg`)}" alt="" />4th Floor, Plot No. 7, Sector 44, Institutional Area, Gurugram, Haryana - 122003, Haryana India</p>
          <a class="contact-row" href="tel:+911244682650"><img src="${k(`images/footer-phone.svg`)}" alt="" />(0124) 4682650</a>
          <a class="contact-row" href="mailto:corporate@eaplworld.com"><img src="${k(`images/footer-email.svg`)}" alt="" />corporate@eaplworld.com</a>
        </section>
        <section class="footer-group social-group">
          <h4>Social</h4>
          <div class="socials">
            <a href="#" aria-label="Facebook"><img src="${j.facebook}" alt="" /></a>
            <a href="#" aria-label="LinkedIn"><img src="${j.linkedin}" alt="" /></a>
            <a href="#" aria-label="Instagram"><img src="${j.instagram}" alt="" /></a>
            <a href="#" aria-label="YouTube"><img src="${j.youtube}" alt="" /></a>
            <a href="#" aria-label="X"><img src="${j.twitter}" alt="" /></a>
          </div>
        </section>
      </div>
    </div>
...
`})),F=t((()=>{_(),v(),y(),b(),x(),S(),C(),w(),T(),E(),P(),D(),`scrollRestoration`in window.history&&(window.history.scrollRestoration=`manual`);var e=document.querySelector(`[data-menu-toggle]`),t=document.querySelector(`[data-mobile-menu]`),n=document.querySelector(`[data-header]`),r=document.querySelector(`[data-desktop-menu]`),i=[...document.querySelectorAll(`[data-desktop-trigger]`)],a=[...document.querySelectorAll(`[data-desktop-panel]`)],o=[...document.querySelectorAll(`.mobile-nav-trigger`)],s,c,l,u=``,d,f;function p(){s=new g({duration:1.15,easing:e=>Math.min(1,1.001-2**(-10*e)),smoothWheel:!0});function e(t){s.raf(t),requestAnimationFrame(e)}requestAnimationFrame(e)}function m(){let n=e?.getAttribute(`aria-expanded`)===`true`;e?.setAttribute(`aria-expanded`,`false`),e?.setAttribute(`aria-label`,`Open menu`),t?.classList.remove(`is-open`),document.body.classList.remove(`menu-open`),o.forEach(e=>{e.setAttribute(`aria-expanded`,`false`),e.parentElement?.classList.remove(`is-expanded`)}),n&&s?.start()}function h(){e?.addEventListener(`click`,()=>{let n=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,String(!n)),e.setAttribute(`aria-label`,n?`Open menu`:`Close menu`),t?.classList.toggle(`is-open`,!n),document.body.classList.toggle(`menu-open`,!n),n?s?.start():s?.stop()}),t?.addEventListener(`click`,e=>{e.target instanceof Element&&e.target.closest(`a`)&&m()}),o.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.parentElement,n=e.getAttribute(`aria-expanded`)!==`true`;o.forEach(t=>{t!==e&&(t.setAttribute(`aria-expanded`,`false`),t.parentElement?.classList.remove(`is-expanded`))}),e.setAttribute(`aria-expanded`,String(n)),t?.classList.toggle(`is-expanded`,n)})})}function O(){window.clearTimeout(c),window.clearTimeout(l),r?.classList.remove(`is-open`),i.forEach(e=>{e.classList.remove(`is-active`),e.setAttribute(`aria-expanded`,`false`)}),a.forEach(e=>e.classList.remove(`is-active`,`is-leaving`)),u=``}function k(e){window.clearTimeout(c),window.clearTimeout(l);let t=a.find(t=>t.dataset.desktopPanel===e);if(!t)return;if(t.classList.contains(`mega-panel--card`)){let n=i.find(t=>t.dataset.desktopTrigger===e)?.getBoundingClientRect(),r=t.getBoundingClientRect().width||306,a=n?.left||0,o=window.innerWidth-r-56;t.style.left=`${Math.round(Math.min(a,o))}px`}r?.classList.add(`is-open`),i.forEach(t=>{let n=t.dataset.desktopTrigger===e;t.classList.toggle(`is-active`,n),t.setAttribute(`aria-expanded`,String(n))});let n=a.find(e=>e.classList.contains(`is-active`));n&&n!==t&&(n.classList.remove(`is-active`),n.classList.add(`is-leaving`),l=window.setTimeout(()=>n.classList.remove(`is-leaving`),240)),a.forEach(e=>{e!==t&&e!==n&&e.classList.remove(`is-active`,`is-leaving`)}),u!==e&&(t.classList.remove(`is-leaving`),requestAnimationFrame(()=>t.classList.add(`is-active`))),u=e}function A(){window.clearTimeout(c),c=window.setTimeout(O,260)}function j(){i.forEach(e=>{let t=e.dataset.desktopTrigger;e.addEventListener(`mouseenter`,()=>k(t)),e.addEventListener(`focus`,()=>k(t)),e.addEventListener(`click`,()=>{e.getAttribute(`aria-expanded`)===`true`?O():k(t)})}),n?.addEventListener(`mouseenter`,()=>window.clearTimeout(c)),n?.addEventListener(`mouseleave`,A),r?.addEventListener(`mouseenter`,()=>window.clearTimeout(c)),r?.addEventListener(`mouseleave`,A),document.addEventListener(`pointerdown`,e=>{!(e.target instanceof Node)||n?.contains(e.target)||O()}),document.addEventListener(`keydown`,t=>{t.key===`Escape`&&(O(),m(),s?.start(),e?.focus())}),window.addEventListener(`resize`,()=>{u&&k(u)})}function M(){n?.classList.toggle(`is-scrolled`,window.scrollY>12)}function N(){return n?window.matchMedia(`(min-width: 821px)`).matches?-86:-n.offsetHeight:0}function F(){document.addEventListener(`click`,e=>{if(!(e.target instanceof Element))return;let t=e.target.closest(`a[href^="#"]`);if(!(t instanceof HTMLAnchorElement))return;let n=t.getAttribute(`href`);if(!n||n===`#`)return;let r=document.querySelector(n);r&&(e.preventDefault(),m(),s?.scrollTo(r,{offset:N()}))})}function I(e){if(!(e instanceof HTMLAnchorElement)||e.target||e.hasAttribute(`download`)||!e.href||e.protocol!==window.location.protocol||e.origin!==window.location.origin||e.pathname===window.location.pathname&&e.hash)return!1;let t=e.pathname.split(`/`).pop()||`index.html`;return[`index.html`,`about.html`,`eapl-in-numbers.html`,`corporate-history.html`,`leadership.html`,`corporate-governance.html`,`policies.html`,`disclosures.html`,`business.html`,`last-mile-e-mobility-solutions.html`,`residential-solar-with-storage.html`,`continued-energy-solutions.html`,`advanced-electronics-manufacturing.html`,`manufacturing-infrastructure.html`,`lithium-batteries.html`,`power-electronics.html`,`solar-panels.html`,`conventional-tubular-batteries.html`].includes(t)}async function L(e,{push:t=!0}={}){let n=await fetch(e,{headers:{"X-Requested-With":`fetch`}});if(!n.ok)throw Error(`Unable to load ${e}`);let r=await n.text(),i=new DOMParser().parseFromString(r,`text/html`),a=i.querySelector(`main`),o=document.querySelector(`main`);if(!a||!o){window.location.href=e;return}o.replaceWith(a),document.title=i.title||document.title,document.body.className=i.body.className,m(),O(),t&&window.history.pushState({},document.title,e),q();let c=window.location.hash?document.querySelector(window.location.hash):null;c?s?.scrollTo(c,{offset:N(),immediate:!0}):(window.scrollTo(0,0),s?.scrollTo(0,{immediate:!0}))}function R(){document.addEventListener(`click`,e=>{if(!(e.target instanceof Element))return;let t=e.target.closest(`a`);I(t)&&(e.preventDefault(),L(t.href).catch(()=>{window.location.href=t.href}))}),window.addEventListener(`popstate`,()=>{L(window.location.href,{push:!1}).catch(()=>window.location.reload())})}function z(e,t,n){let r=e.toLocaleString(`en-IN`,{maximumFractionDigits:t,minimumFractionDigits:t});return n===`GWh`?`${r}<span>GWh</span>`:`${r}${n}`}function B(e){if(e.dataset.animated===`true`)return;e.dataset.animated=`true`;let t=Number(e.dataset.value||0),n=Number(e.dataset.decimals||0),r=e.dataset.suffix||``,i=performance.now();function a(o){let s=o-i,c=Math.min(s/1400,1);e.innerHTML=z(t*(1-(1-c)**3),n,r),c<1?requestAnimationFrame(a):e.innerHTML=z(t,n,r)}requestAnimationFrame(a)}function V(){let e=document.querySelectorAll(`[data-counter]`),t=new Map;e.forEach(e=>{let n=e.closest(`section`)||e.parentElement;t.has(n)||t.set(n,[]),t.get(n).push(e)});let n=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(t.get(e.target)?.forEach(e=>B(e)),n.unobserve(e.target))})},{rootMargin:`0px 0px -12% 0px`,threshold:.2});t.forEach((e,t)=>{e.forEach(e=>{e.dataset.animated=`false`,e.innerHTML=z(0,Number(e.dataset.decimals||0),e.dataset.suffix||``)});let r=t.getBoundingClientRect();if(r.top<window.innerHeight&&r.bottom>0){requestAnimationFrame(()=>e.forEach(e=>B(e)));return}n.observe(t)})}function H(){let e=document.querySelectorAll(`main > section, .site-footer`);if(window.matchMedia(`(prefers-reduced-motion: reduce)`).matches){e.forEach(e=>e.classList.add(`is-visible`));return}let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`is-visible`),t.unobserve(e.target))})},{rootMargin:`0px 0px -12% 0px`,threshold:.12});e.forEach(e=>{let n=e.getBoundingClientRect(),r=n.top<window.innerHeight&&n.bottom>0;if(e.classList.add(`reveal-section`),r){e.classList.add(`is-visible`);return}t.observe(e)})}function U(){if(!d||!f)return;let e=d.querySelector(`.solution-label`);if(!e)return;let t=d.getBoundingClientRect(),n=d.classList.contains(`wide`);f.textContent=e.textContent||``,f.style.left=`${t.left+t.width/2}px`,f.style.top=`${n?t.bottom+34:t.top-24}px`}function W(){f?.classList.remove(`is-visible`),d=void 0}function G(e){window.matchMedia(`(min-width: 821px)`).matches&&(f||(f=document.createElement(`span`),f.className=`floating-solution-label`,document.body.appendChild(f)),d=e,U(),requestAnimationFrame(()=>f?.classList.add(`is-visible`)))}function K(){[...document.querySelectorAll(`.solution-card`)].forEach(e=>{e.addEventListener(`mouseenter`,()=>G(e)),e.addEventListener(`focusin`,()=>G(e)),e.addEventListener(`mouseleave`,W),e.addEventListener(`focusout`,t=>{t.relatedTarget instanceof Node&&e.contains(t.relatedTarget)||W()})}),window.addEventListener(`resize`,U),window.addEventListener(`scroll`,U,{passive:!0})}function q(){K(),H(),V(),M()}function J(){p(),h(),j(),F(),R(),q(),window.addEventListener(`scroll`,M,{passive:!0})}J()}));export{S as n,t as r,F as t};