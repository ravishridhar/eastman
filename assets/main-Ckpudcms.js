  ...
  <header class="site-header" data-header>
    ...
    <div class="header-actions">
      ...
      <button class="menu-toggle" type="button" aria-expanded="false" aria-controls="mobile-menu" aria-label="Open menu" data-menu-toggle>
        <img src="${D(`images/menu-icon.svg`)}" alt="" />
    ...
    <div class="desktop-mega-menu" data-desktop-menu>
      ...
      <section class="mega-panel mega-panel--card" data-desktop-panel="research" aria-label="Research and Development submenu">
        ...
        <a href="${O(`#research`)}">Overview</a>
        <a href="${O(`#research`)}">Conventional Tubular Batteries</a>
        <a href="${O(`#research`)}">Power Electronics</a>
        <a href="${O(`#research`)}">Lithium-ion Batteries Solar Panels</a>
      </section>
      <section class="mega-panel mega-panel--card" data-desktop-panel="manufacturing" aria-label="Manufacturing Infrastructure submenu">
        ...
        <a href="${O(`#manufacturing`)}">Overview</a>
        <a href="${O(`#manufacturing`)}">Conventional Tubular Batteries</a>
        <a href="${O(`#manufacturing`)}">Power Electronics</a>
        <a href="${O(`#manufacturing`)}">Lithium-ion Batteries Solar Panels</a>
      </section>
      <section class="mega-panel mega-panel--card" data-desktop-panel="businesses" aria-label="Our Businesses submenu">
        <h2>Our Businesses</h2>
        <a href="${O(`#businesses`)}">Last Mile E-Mobility Solutions</a>
        <a href="${O(`#businesses`)}">Residential Solar With Storage</a>
        <a href="${O(`#businesses`)}">Continued Energy Solutions</a>
        <a href="${O(`#businesses`)}">Advanced Electronics Manufacturing</a>
        <a href="${O(`#businesses`)}">Global Business</a>
      </section>
      <section class="mega-panel mega-panel--card" data-desktop-panel="resources" aria-label="Resources submenu">
        <h2>Resources</h2>
        <a href="${O(`#resources`)}">Overview</a>
        <a href="${O(`#resources`)}">Blogs</a>
        <a href="${O(`#resources`)}">Whitepaper</a>
        <a href="${O(`#resources`)}">Media</a>
        <a href="${O(`#resources`)}">Social Feed</a>
        <a href="${O(`#resources`)}">Videos</a>
      </section>
      <section class="mega-panel mega-panel--card" data-desktop-panel="life" aria-label="Life at Eastman submenu">
        <h2>Life @ Eastman</h2>
        <a href="${O(`#life`)}">Great Place to Work</a>
        <a href="${O(`#life`)}">Careers</a>
      </section>
    </div>
  </header>
  ...
  <nav class="mobile-menu" id="mobile-menu" aria-label="Mobile navigation" data-mobile-menu>
    <div class="mobile-menu-inner" data-lenis-prevent>
      <div class="mobile-nav-item">
        <button type="button" class="mobile-nav-trigger" aria-expanded="false">About Us<img src="${D(`images/nav-chevron.svg`)}" alt="" /></button>
        <div class="mobile-submenu">
          <a href="${O(`about.html`)}">Explore About Us</a>
          <h3>Company</h3>
          <a href="${O(`about.html`)}">Overview &amp; Group Companies</a>
          <a href="${O(`eapl-in-numbers.html`)}">Eastman in Numbers</a>
      ...
      <div class="mobile-nav-item">
        <button type="button" class="mobile-nav-trigger" aria-expanded="false">Research &amp; Development<img src="${D(`images/nav-chevron.svg`)}" alt="" /></button>
        <div class="mobile-submenu">
          <a href="${O(`#research`)}">Overview</a>
          <a href="${O(`#research`)}">Conventional Energy Storage</a>
          <a href="${O(`#research`)}">Power Electronics</a>
          <a href="${O(`#research`)}">Lithium-Ion Battery Pack</a>
        </div>
      </div>
      <div class="mobile-nav-item">
        <button type="button" class="mobile-nav-trigger" aria-expanded="false">Manufacturing Infrastructure<img src="${D(`images/nav-chevron.svg`)}" alt="" /></button>
        <div class="mobile-submenu">
          <a href="${O(`#manufacturing`)}">Overview</a>
          <a href="${O(`#manufacturing`)}">Conventional Tubular Batteries</a>
          <a href="${O(`#manufacturing`)}">Lithium-ion Batteries</a>
          <a href="${O(`#manufacturing`)}">Power Electronics</a>
          <a href="${O(`#manufacturing`)}">Solar Panels</a>
        </div>
      </div>
      <div class="mobile-nav-item">
        <button type="button" class="mobile-nav-trigger" aria-expanded="false">Our Businesses<img src="${D(`images/nav-chevron.svg`)}" alt="" /></button>
        <div class="mobile-submenu">
          <a href="${O(`#businesses`)}">Last Mile E-Mobility Solutions</a>
          <a href="${O(`#businesses`)}">Solar Solutions</a>
          <a href="${O(`#businesses`)}">Continued Energy Solutions</a>
          <a href="${O(`#businesses`)}">Global Businesses</a>
        </div>
      </div>
      <div class="mobile-nav-item">
        <button type="button" class="mobile-nav-trigger" aria-expanded="false">Resources<img src="${D(`images/nav-chevron.svg`)}" alt="" /></button>
        <div class="mobile-submenu">
          <a href="${O(`#resources`)}">Overview</a>
          <a href="${O(`#resources`)}">Blogs</a>
          <a href="${O(`#resources`)}">White Paper</a>
          <a href="${O(`#resources`)}">Media</a>
          <a href="${O(`#resources`)}">Videos</a>
          <a href="${O(`#resources`)}">Social Feed</a>
        </div>
      ...
      <div class="mobile-nav-item">
        <button type="button" class="mobile-nav-trigger" aria-expanded="false">Life@Eastman<img src="${D(`images/nav-chevron.svg`)}" alt="" /></button>
        <div class="mobile-submenu">
          <a href="${O(`#life`)}">Great Place to Work</a>
          <a href="${O(`#life`)}">Careers</a>
        </div>
      ...
      <div class="mobile-menu-actions">
        <a class="phone-link" href="tel:18004198610"><img src="${D(`images/phone-icon.svg`)}" alt="" />1800 419 8610</a>
        <a class="trade-chip" href="#contact">Trade Enquiry</a>
      </div>
    </div>
  </nav>
  ...
  <footer class="site-footer" id="contact">
    <div class="footer-grid">
      <div class="footer-column footer-brand-column">
        <a class="footer-brand" href="${O()}" aria-label="Eastman home">
          <img src="${D(`images/footer_logo.svg`)}" alt="Eastman" />
        </a>
        ...
        <section class="footer-group">
          <h3>About Us</h3>
          <a href="${O(`about.html`)}">About JRS Eastman</a>
          <a href="${O(`about.html`)}">EAPL &amp; Group Companies</a>
          <a href="${O(`about.html`)}">Our Values</a>
      ...
      <div class="footer-column">
        <section class="footer-group">
          ...
          <a href="${O(`#research`)}">Conventional Tubular Batteries</a>
          <a href="${O(`#research`)}">Power Electronics</a>
          <a href="${O(`#research`)}">Lithium-ion Batteries</a>
          <a href="${O(`#research`)}">Solar Panels</a>
        </section>
        <section class="footer-group">
      ...
      <div class="footer-column contact-col">
        <section class="footer-group">
          ...
          <p class="contact-row"><img src="${D(`images/footer-location.svg`)}" alt="" />4th Floor, Plot No. 7, Sector 44, Institutional Area, Gurugram, Haryana - 122003, Haryana India</p>
          <a class="contact-row" href="tel:+911244682650"><img src="${D(`images/footer-phone.svg`)}" alt="" />(0124) 4682650</a>
          <a class="contact-row" href="mailto:corporate@eaplworld.com"><img src="${D(`images/footer-email.svg`)}" alt="" />corporate@eaplworld.com</a>
        </section>
        <section class="footer-group social-group">
          <h4>Social</h4>
          <div class="socials">
            <a href="#" aria-label="Facebook"><img src="${D(`images/social-facebook.svg`)}" alt="" /></a>
            <a href="#" aria-label="LinkedIn"><img src="${D(`images/social-linkedin.svg`)}" alt="" /></a>
            <a href="#" aria-label="Instagram"><img src="${D(`images/social-instagram.svg`)}" alt="" /></a>
            <a href="#" aria-label="YouTube"><img src="${D(`images/social-youtube.svg`)}" alt="" /></a>
            <a href="#" aria-label="X"><img src="${D(`images/social-x.svg`)}" alt="" /></a>
          </div>
        </section>
      </div>
    </div>
...
`})),M=t((()=>{_(),v(),y(),b(),x(),S(),C(),w(),j(),T();var e=document.querySelector(`[data-menu-toggle]`),t=document.querySelector(`[data-mobile-menu]`),n=document.querySelector(`[data-header]`),r=document.querySelector(`[data-desktop-menu]`),i=[...document.querySelectorAll(`[data-desktop-trigger]`)],a=[...document.querySelectorAll(`[data-desktop-panel]`)],o=[...document.querySelectorAll(`.mobile-nav-trigger`)],s,c,l,u=``,d,f;function p(){s=new g({duration:1.15,easing:e=>Math.min(1,1.001-2**(-10*e)),smoothWheel:!0});function e(t){s.raf(t),requestAnimationFrame(e)}requestAnimationFrame(e)}function m(){let n=e?.getAttribute(`aria-expanded`)===`true`;e?.setAttribute(`aria-expanded`,`false`),e?.setAttribute(`aria-label`,`Open menu`),t?.classList.remove(`is-open`),document.body.classList.remove(`menu-open`),o.forEach(e=>{e.setAttribute(`aria-expanded`,`false`),e.parentElement?.classList.remove(`is-expanded`)}),n&&s?.start()}function h(){e?.addEventListener(`click`,()=>{let n=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,String(!n)),e.setAttribute(`aria-label`,n?`Open menu`:`Close menu`),t?.classList.toggle(`is-open`,!n),document.body.classList.toggle(`menu-open`,!n),n?s?.start():s?.stop()}),t?.addEventListener(`click`,e=>{e.target instanceof Element&&e.target.closest(`a`)&&m()}),o.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.parentElement,n=e.getAttribute(`aria-expanded`)!==`true`;o.forEach(t=>{t!==e&&(t.setAttribute(`aria-expanded`,`false`),t.parentElement?.classList.remove(`is-expanded`))}),e.setAttribute(`aria-expanded`,String(n)),t?.classList.toggle(`is-expanded`,n)})})}function E(){window.clearTimeout(c),window.clearTimeout(l),r?.classList.remove(`is-open`),i.forEach(e=>{e.classList.remove(`is-active`),e.setAttribute(`aria-expanded`,`false`)}),a.forEach(e=>e.classList.remove(`is-active`,`is-leaving`)),u=``}function D(e){window.clearTimeout(c),window.clearTimeout(l);let t=a.find(t=>t.dataset.desktopPanel===e);if(!t)return;if(t.classList.contains(`mega-panel--card`)){let n=i.find(t=>t.dataset.desktopTrigger===e)?.getBoundingClientRect(),r=t.getBoundingClientRect().width||306,a=n?.left||0,o=window.innerWidth-r-56;t.style.left=`${Math.round(Math.min(a,o))}px`}r?.classList.add(`is-open`),i.forEach(t=>{let n=t.dataset.desktopTrigger===e;t.classList.toggle(`is-active`,n),t.setAttribute(`aria-expanded`,String(n))});let n=a.find(e=>e.classList.contains(`is-active`));n&&n!==t&&(n.classList.remove(`is-active`),n.classList.add(`is-leaving`),l=window.setTimeout(()=>n.classList.remove(`is-leaving`),240)),a.forEach(e=>{e!==t&&e!==n&&e.classList.remove(`is-active`,`is-leaving`)}),u!==e&&(t.classList.remove(`is-leaving`),requestAnimationFrame(()=>t.classList.add(`is-active`))),u=e}function O(){c=window.setTimeout(E,130)}function k(){i.forEach(e=>{let t=e.dataset.desktopTrigger;e.addEventListener(`mouseenter`,()=>D(t)),e.addEventListener(`focus`,()=>D(t)),e.addEventListener(`click`,()=>{e.getAttribute(`aria-expanded`)===`true`?E():D(t)}),e.addEventListener(`mouseleave`,O)}),r?.addEventListener(`mouseenter`,()=>window.clearTimeout(c)),r?.addEventListener(`mouseleave`,O),document.addEventListener(`pointerdown`,e=>{!(e.target instanceof Node)||n?.contains(e.target)||E()}),document.addEventListener(`keydown`,t=>{t.key===`Escape`&&(E(),m(),s?.start(),e?.focus())}),window.addEventListener(`resize`,()=>{u&&D(u)})}function A(){n?.classList.toggle(`is-scrolled`,window.scrollY>12)}function M(){document.addEventListener(`click`,e=>{if(!(e.target instanceof Element))return;let t=e.target.closest(`a[href^="#"]`);if(!(t instanceof HTMLAnchorElement))return;let r=t.getAttribute(`href`);if(!r||r===`#`)return;let i=document.querySelector(r);i&&(e.preventDefault(),m(),s?.scrollTo(i,{offset:-(n?.offsetHeight||0)}))})}function N(e){return!(e instanceof HTMLAnchorElement)||e.target||e.hasAttribute(`download`)||!e.href||e.protocol!==window.location.protocol||e.origin!==window.location.origin||e.pathname===window.location.pathname&&e.hash?!1:e.pathname.startsWith(`/eastman/`)}async function P(e,{push:t=!0}={}){let r=await fetch(e,{headers:{"X-Requested-With":`fetch`}});if(!r.ok)throw Error(`Unable to load ${e}`);let i=await r.text(),a=new DOMParser().parseFromString(i,`text/html`),o=a.querySelector(`main`),c=document.querySelector(`main`);if(!o||!c){window.location.href=e;return}c.replaceWith(o),document.title=a.title||document.title,document.body.className=a.body.className,m(),E(),t&&window.history.pushState({},document.title,e),W();let l=window.location.hash?document.querySelector(window.location.hash):null;l?s?.scrollTo(l,{offset:-(n?.offsetHeight||0),immediate:!0}):s?.scrollTo(0,{immediate:!0})}function F(){document.addEventListener(`click`,e=>{if(!(e.target instanceof Element))return;let t=e.target.closest(`a`);N(t)&&(e.preventDefault(),P(t.href).catch(()=>{window.location.href=t.href}))}),window.addEventListener(`popstate`,()=>{P(window.location.href,{push:!1}).catch(()=>window.location.reload())})}function I(e,t,n){let r=e.toLocaleString(`en-IN`,{maximumFractionDigits:t,minimumFractionDigits:t});return n===`GWh`?`${r}<span>GWh</span>`:`${r}${n}`}function L(e){let t=Number(e.dataset.value||0),n=Number(e.dataset.decimals||0),r=e.dataset.suffix||``,i=performance.now();function a(o){let s=o-i,c=Math.min(s/1400,1);e.innerHTML=I(t*(1-(1-c)**3),n,r),c<1?requestAnimationFrame(a):e.innerHTML=I(t,n,r)}requestAnimationFrame(a)}function R(){let e=document.querySelectorAll(`[data-counter]`),t=new Map;e.forEach(e=>{let n=e.closest(`section`)||e.parentElement;t.has(n)||t.set(n,[]),t.get(n).push(e)});let n=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(t.get(e.target)?.forEach(e=>L(e)),n.unobserve(e.target))})},{rootMargin:`0px 0px -12% 0px`,threshold:.2});t.forEach((e,t)=>{e.forEach(e=>{e.innerHTML=I(0,Number(e.dataset.decimals||0),e.dataset.suffix||``)}),n.observe(t)})}function z(){let e=document.querySelectorAll(`main > section, .site-footer`);if(window.matchMedia(`(prefers-reduced-motion: reduce)`).matches){e.forEach(e=>e.classList.add(`is-visible`));return}e.forEach(e=>e.classList.add(`reveal-section`));let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`is-visible`),t.unobserve(e.target))})},{rootMargin:`0px 0px -12% 0px`,threshold:.12});e.forEach(e=>t.observe(e))}function B(){if(!d||!f)return;let e=d.querySelector(`.solution-label`);if(!e)return;let t=d.getBoundingClientRect(),n=d.classList.contains(`wide`);f.textContent=e.textContent||``,f.style.left=`${t.left+t.width/2}px`,f.style.top=`${n?t.bottom+50:t.top-35}px`}function V(){f?.classList.remove(`is-visible`),d=void 0}function H(e){window.matchMedia(`(min-width: 821px)`).matches&&(f||(f=document.createElement(`span`),f.className=`floating-solution-label`,document.body.appendChild(f)),d=e,B(),requestAnimationFrame(()=>f?.classList.add(`is-visible`)))}function U(){[...document.querySelectorAll(`.solution-card`)].forEach(e=>{e.addEventListener(`mouseenter`,()=>H(e)),e.addEventListener(`focusin`,()=>H(e)),e.addEventListener(`mouseleave`,V),e.addEventListener(`focusout`,t=>{t.relatedTarget instanceof Node&&e.contains(t.relatedTarget)||V()})}),window.addEventListener(`resize`,B),window.addEventListener(`scroll`,B,{passive:!0})}function W(){U(),z(),R(),A()}function G(){p(),h(),k(),M(),F(),W(),window.addEventListener(`scroll`,A,{passive:!0})}G()}));export{S as n,t as r,M as t};