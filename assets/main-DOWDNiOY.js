  ...
  <header class="site-header" data-header>
    ...
    <div class="header-nav-stack">
      ...
      <nav class="desktop-nav" aria-label="Primary navigation">
        ...
        <button type="button" data-desktop-trigger="research" data-nav-href="${N(`research-conventional-tubular-batteries.html`)}" aria-expanded="false">Research &amp; Development<img src="${M(`images/nav-chevron.svg`)}" alt="" class="nav-chevron" /></button>
        ...
        <a href="${N(`life-at-eastman.html`)}">Life@Eastman</a>
      </nav>
    </div>
    ...
    <div class="desktop-mega-menu" data-desktop-menu>
      <section class="mega-panel mega-panel--card" data-desktop-panel="about" aria-label="About Us submenu">
        ...
        <!--<a href="${N(`leadership-team.html`)}">Leadership Team</a>
        <a href="${N(`board-committee.html`)}">Board Committee</a>-->
        <a href="${N(`shareholders-information.html`)}">Shareholder Information</a>
      ...
      <section class="mega-panel mega-panel--card" data-desktop-panel="resources" aria-label="Resources submenu">
        <!-- <h2>Resources</h2> -->
        <a href="${N(`resources.html`)}">Overview</a>
        <a href="${N(`blog.html`)}">Blogs</a>
        <a href="${N(`white-papers.html`)}">White Papers</a>
        <a href="${N(`media-news.html`)}">Media</a>
        <a href="${N(`social-feed.html`)}">Social Feed</a>
        <a href="${N(`videos.html`)}">Videos</a>
      </section>
    ...
    <div class="mobile-menu-inner" data-lenis-prevent>
      <div class="mobile-nav-item">
        ...
        <div class="mobile-submenu">
          ...
          <!--<a href="${N(`leadership-team.html`)}">Leadership Team</a>
          <a href="${N(`board-committee.html`)}">Board Committee</a>-->
          <a href="${N(`shareholders-information.html`)}">Shareholders Information</a>
        </div>
      </div>
      <div class="mobile-nav-item">
        ...
        <div class="mobile-submenu">
          <a href="${N(`research-conventional-tubular-batteries.html`)}">Explore Research &amp; Development</a>
          <a href="${N(`research-conventional-tubular-batteries.html`)}">Conventional Tubular Batteries</a>
          <a href="${N(`research-power-electronics.html`)}">Power Electronics</a>
          <a href="${N(`research-lithium-batteries.html`)}">Lithium-Ion Batteries</a>
          <a href="${N(`research-solar-panels.html`)}">Solar Panels</a>
      ...
      <div class="mobile-nav-item">
        ...
        <div class="mobile-submenu">
          <a href="${N(`resources.html`)}">Overview</a>
          <a href="${N(`blog.html`)}">Blogs</a>
          <a href="${N(`white-papers.html`)}">White Paper</a>
          <a href="${N(`media-news.html`)}">Media</a>
          <a href="${N(`videos.html`)}">Videos</a>
          <a href="${N(`social-feed.html`)}">Social Feed</a>
        </div>
      ...
      <div class="mobile-nav-item">
        <a class="mobile-direct-link mobile-direct-link--no-arrow" href="${N(`life-at-eastman.html`)}">Life@Eastman</a>
        <!-- <div class="mobile-submenu">
          <a href="${N(`#life`)}">Great Place to Work</a>
          <a href="${N(`#life`)}">Careers</a>
        </div> -->
    ...
    <div class="footer-grid">
      <div class="footer-column footer-brand-column">
        <a class="footer-brand" href="${N()}" aria-label="Eastman home">
          <img src="${M(`images/eastman-logo-new.svg`)}" alt="Eastman" />
        </a>
      ...
      <div class="footer-column contact-col">
        ...
        <section class="footer-group">
          ...
          <p class="contact-row"><img src="${M(`images/footer-location.svg`)}" alt="" />4th Floor, Quattro Tower A, Plot No. 249-E, Udyog Vihar Phase IV, Industrial Complex Dundahera, Gurgaon - 122016, Haryana, India</p>
        ...
        <section class="footer-group social-group">
          <h4>Social</h4>
          <div class="socials">
            <a href="https://www.facebook.com/EastmanIndia/" target="_blank" rel="noopener noreferrer" aria-label="Facebook"><img src="${P.facebook}" alt="" /></a>
            <a href="https://www.linkedin.com/company/eastman-auto-power-limited/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><img src="${P.linkedin}" alt="" /></a>
            <a href="https://www.instagram.com/eastman_india/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><img src="${P.instagram}" alt="" /></a>
            <a href="https://www.youtube.com/@eastmanindia/videos" target="_blank" rel="noopener noreferrer" aria-label="YouTube"><img src="${P.youtube}" alt="" /></a>
