    ...
    <div class="footer-grid">
      ...
      <div class="footer-column contact-col">
        ...
        <section class="footer-group social-group">
          <h4>Social</h4>
          <div class="socials">
            <a href="#" aria-label="Facebook"><img src="${k(`images/social-facebook.svg`)}" alt="" /></a>
            <a href="#" aria-label="LinkedIn"><img src="${k(`images/social-linkedin.svg`)}" alt="" /></a>
            <a href="#" aria-label="Instagram"><img src="${k(`images/social-instagram.svg`)}" alt="" /></a>
            <a href="#" aria-label="YouTube"><img src="${k(`images/social-youtube.svg`)}" alt="" /></a>
            <a href="#" aria-label="X"><img src="${k(`images/social-x.svg`)}" alt="" /></a>
          </div>
        </section>
      </div>
    </div>
